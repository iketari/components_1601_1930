...
/***/ function(module, exports, __webpack_require__) {
	...
	var AvatarService = window.AvatarService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chat = function () {
		...
		_createClass(Chat, [{
			...
			value: function render() {
				this._saveScrollTop();
				this.el.innerHTML = (0, _chat2.default)(this.getData());
	   ...
	   */
			...
			key: 'onScrollStart',
			value: function onScrollStart(cb) {
				console.info('Метод onScrollStart не реализован');
			}
		}, {
			key: 'onScrollEnd',
			value: function onScrollEnd(cb) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (messages, user) {pug_html = pug_html + "\u003Cdiv class=\"chat\"\u003E\u003Cdiv class=\"chat__container\"\u003E\u003Cdiv class=\"header\"\u003E";
	if (!user) {
	pug_html = pug_html + "\u003Cinput class=\"chat__userinput\"\u003E";
	}
	else {
	pug_html = pug_html + "\u003Ch2\u003E" + (pug.escape(null == (pug_interp = 'Добро пожаловать ' + user) ? "" : pug_interp)) + "\u003C\u002Fh2\u003E";
	}
	pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"chat__box\"\u003E";
	if (!messages.length) {
